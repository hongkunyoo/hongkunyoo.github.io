...
> 실제 사용자의 key를 서버로 전송하는 것이 아니라 사용자가 가진 key로 서명한 데이터를 서버로 전송함으로써 인증서의 소유권을 주장합니다. 이 부분은 [@devhak2](https://github.com/devhak2)님이 댓글로 정정해 주셨습니다. (https://github.com/hongkunyoo/blog-comments/issues/32#issuecomment-1169447523)
