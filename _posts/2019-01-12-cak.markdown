...
##### 9. [edX Introduction to Kubernetes (무료)](https://www.edx.org/course/introduction-to-kubernetes)
...
##### 10. [Linux Foundation Training (유료)](https://training.linuxfoundation.org/training/kubernetes-fundamentals/)
