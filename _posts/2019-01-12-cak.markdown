...
##### 5. [Katacoda Playground](https://www.katacoda.com/courses/kubernetes/playground)
`Play with kubernetes` 와 비슷하게 웹상에서 쿠버네티스 클러스터를 조작해 볼 수 있게 해줍니다. 또한 따라해 볼 수 있는 튜토리얼이 잘 만들어져 있습니다.

##### 6. [CKA practice 환경](https://github.com/arush-sal/cka-practice-environment)
